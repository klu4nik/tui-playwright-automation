...
test.describe('Part A – Full funnel: Passenger Details form validation', () => {
  ...
  test.beforeEach(async ({
    ...
    await navigateToPassengerDetails({ homePage, hotelListPage, hotelDetailsPage, flightSelectionPage, passengerDetailsPage });
  });
...
test.describe('Part B – Field-level validation on Passenger Details', () => {
  ...
  test('B1  – Missing first name shows a required-field error', async ({
    passengerDetailsPage,
  }) => {
